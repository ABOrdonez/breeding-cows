...
def breeding_cows_list(request):
    ...
    return render(request, 'breedingcows/breeding_cows_list.html', {'breeding_cows': breeding_cows})


def breeding_cow_detail(request, pk):
    breeding_cow = get_object_or_404(BreedingCows, pk=pk)
    return render(request, 'breedingcows/breeding_cow_detail.html', {'breeding_cow': breeding_cow})
